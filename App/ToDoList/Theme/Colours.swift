...
fileprivate enum FlatColor { // swiftlint:disable:this private_over_fileprivate
	enum Green {
		...
		static let ChateauGreen = UIColor(hex: 0x21A598)
...
fileprivate enum Colors { // swiftlint:disable:this private_over_fileprivate
	static let red = UIColor.color(light: FlatColor.Red.TerraCotta, dark: FlatColor.Red.Cinnabar)
...
enum Theme {
	static let mainColor = Colors.green
